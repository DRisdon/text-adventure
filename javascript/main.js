$(document).ready(function() {
  ...
  var scenes = [
    ['start', 'An evil wizard from another dimension just stole your laptop, leaving open a portal to his world! What should you do?', './images/backgrounds/home.jpg', [
    ...
    ['fork', 'You come to a fork in the dirt road. On the ground is a stick you can use as a weapon for the time being. On your left, you can see a distant village, but it\'s under attack! Do you go into the town to try to help, or take the path around it?', './images/backgrounds/forkinroad.jpg', [
    ...
    ['town_attack', 'You head into the town, and find a bandit on a rampage! Do you fight him or run?', './images/backgrounds/town.jpg', [
      ['Fight!', 'rope_bridge', 'bandit', '', '9'],
      ['Run away!', 'rope_bridge', 'bandit', '', '10']
    ]],
    ['rope_bridge', 'You come to a canyon with an old rope bridge that looks like it might collapse! (this always goes well in movies...) Do you try to cross it, or take the long way around?', './images/backgrounds/ropebridge.jpg', [
      ['Cross it!', 'over_bridge', '', '', '11'],
      ['Go around!', 'long_way', '', '', '12']
    ]],
    ['over_bridge', 'The bridge holds up just fine! On the other side, you find a small shop selling a few useful items! The shopkeeper says "One item per customer!" What do you buy?', './images/backgrounds/town.jpg', [
    ...
    ['mountain_fork', 'You reach the foot of a mountain. There are two paths heading up and over it. A strange hermit on the side of the road says, "Take the left path! I PROMISE it\'s safe!" Which path do you choose?', './images/backgrounds/forkinroad.jpg', [
      ['Left!', 'mountain_left', '', '', '17'],
      ['Right!', 'mountain_right', '', '', '18']
    ], 'hermit'],
    ['mountain_left', 'You take the left path, but after walking for a while, you realize the hermit has been following you. He isn\'t a hermit at all! He\'s another bandit! Who could have guessed!? Fight or run?', './images/backgrounds/mountain.jpg', [
      ['Fight!', 'strong_guy', 'hermit', 'fur armor', '19'],
      ['Run away!', 'strong_guy', 'hermit', '', '20']
    ]],
    ['mountain_right', 'You take the right path, and encounter another wolf! It\'s guarding a dead body that might have useful items! (you weirdo)', './images/backgrounds/mountain.jpg', [
      ['Fight it!', 'strong_guy', 'wolf', 'club', '21'],
      ['Run away!', 'strong_guy', 'wolf', '', '22']
    ]],
    ['strong_guy', 'Along the road, You meet an extremely strong man. "ME WANT FIGHT." he says. Do you fight him?', './images/backgrounds/mountain.jpg', [
    ...
    ['fight_strong_guy', 'You defeat the strong man in battle, and he runs off crying! Maybe he just needed a friend! As you continue down the path, the temperature starts to drop. You find a cave that might be warm, but who knows what might be inside?', './images/backgrounds/caveentrance.jpg', [
      ['Go inside!', 'warm_cave', '', '', '26'],
      ['Continue through the cold!', 'snow_shop', '', '', '27']
    ]],
    ['befriend_strong_guy', 'You calm the strong man down, and he thanks you by giving you a healing potion! It turns out he just needed a friend, and isn\'t good with words! As you continue down the path, the temperature starts to drop. You find a cave that might be warm, but who knows what might be inside?', './images/backgrounds/caveentrance.jpg', [
      ['Go inside!', 'warm_cave', '', '', '28'],
      ['Continue through the cold!', 'snow_shop', '', '', '29']
    ]],
    ['warm_cave', 'The cave seems warm at first, especially once you start a fire, but all of a sudden, a cave troll comes in to find you in his den!', './images/backgrounds/cave.jpg', [
      ['Fight him and get out of there!', 'snow_shop', 'cave troll', '', '30'],
      ['Run away!', 'snow shop', '', '', '31']
    ]],
    ['snow_shop', 'You come to a snowy mountain village with a small shop, where once again you can buy a single item. This deal doesn\'t make much sense. What do you buy?', './images/backgrounds/town.jpg', [
    ...
    ['long_way', 'You choose to take the long way around and find another way across the canyon. You find a sturdier bridge and cross it. Halfway across, a bandit attacks! These guys all seem to look alike...', './images/backgrounds/stonebridge.jpg', [
    ...
    ['mountain_pass', 'You come to the entrance to an underground passage through a large mountain in front of you, but there are two different entrances. Which do you take?', './images/backgrounds/2caves.jpg', [
      ['Right!', 'mountain_pass_right', '', '', '40'],
      ['Left!', 'mountain_pass_left', '', '', '41']
    ]],
    ['mountain_pass_right', 'Deep underground, you encounter a skeleton. Suddenly, it jumps to life and attacks! Wow your luck is terrible!', './images/backgrounds/tunnel.jpg', [
      ['Fight!', 'mountain_pass_shop', 'skeleton', 'skeleton axe', '42'],
      ['Run away!', 'mountain_pass_shop', 'skeleton', '', '43']
    ]],
    ['mountain_pass_left', 'Deep underground, you encounter a prospector, looking for gold. He hasn\'t found any, but he offers you a sword he found for 2 coins. What a steal!', './images/backgrounds/tunnel.jpg', [
      ['Buy it!', 'mountain_pass_shop', '', 'sword', '44'],
      ['Nope!', 'mountain_pass_shop', '', '', '45']
    ], 'prospector'],
    ['mountain_pass_shop', 'You come out the other end of the mountain passage, and find yourself in a village at the foot of the mountain. In town, there is a shop, offering a choice of one item. What do you buy?', './images/backgrounds/town.jpg', [
    ...
    ['rest_town', 'After escaping the mysterious mage, you find yourself in a calm town on the edge of a dark, spooky forest. The local shop doesn\'t have great items, will sell you as many items as you can afford! Maybe you should stock up before heading into the dark woods!', './images/backgrounds/town.jpg', [
    ...
    ['spooky_woods', 'You head out from the village and into the spooky woods. After walking for a while, you are approached by a creepy-looking stranger, who offers you more gold than you could ever imagine. Sounds suspicious. Do you accept?', './images/backgrounds/forest.jpg', [
      ['Yes!', 'skeleton_attack', '', '', '65'],
      ['No!', 'mercenary_attack', '', '', '66']
    ], 'mage'],
    ['skeleton_attack', 'It was a trick! The strange woman waves her hands around, and a skeleton climbs up out of the ground to attack!', './images/backgrounds/forest.jpg', [
      ['Fight!', 'mercenary_attack', 'strong skeleton', '', '67'],
      ['Run away!', 'mercenary_attack', 'strong skeleton', '', '68']
    ]],
    ['mercenary_attack', 'The strange woman goes on her way. Suddenly, you are ambushed by a mercenary, hired to murder you!', './images/backgrounds/forest.jpg', [
      ['Fight!', 'evil_squirrel', 'mercenary', '', '69'],
      ['Run away!', 'evil_squirrel', 'mercenary', '', '70']
    ]],
    ['evil_squirrel', 'After yet another brush with death, you are pleased to encounter a cute squirrel. Do you say hello and pet the little guy? He\'s so cute! Nothing could possibly go wrong!', './images/backgrounds/forest.jpg', [
      ['Pet him!', 'evil_squirrel_attack', '', '', '71'],
      ['Leave him alone!', 'traveling_merchant', '', '', '72']
    ], 'squirrel'],
    ['evil_squirrel_attack', 'You lean in to pet the squirrel, and suddenly, he grows to a massive size, and prepares to attack!', './images/backgrounds/forest.jpg', [
      ['Fight!', 'traveling_merchant', 'squirrel', '', '73'],
      ['Run away!', 'traveling_merchant', 'squirrel', '', '74']
    ]],
    ['traveling_merchant', 'You soon encounter a traveling merchant, the first friendly face you\'ve seen since town. She offers to sell you as many items as you\'d like.', './images/backgrounds/forest.jpg', [
    ...
    ['spooky_fork', 'You arrive at a fork in the road. This one has signs for once! One path leads to the "Spooky Murder Dungeon," (sounds fun!) while the other leads to a place simply called "Murderville." Where do you go?', './images/backgrounds/forkinroad.jpg', [
      ['Spooky Murder Dungeon!', 'murder_dungeon_1', '', '', '79'],
      ['Murderville!', 'murderville_1', '', '', '80']
    ]],
    ['murder_dungeon_1', 'You decide, due to the lack of a better option, to go to the Spooky Murder Dungeon. Immediately upon entering, you are attacked by a skeleton!', './images/backgrounds/dungeon.jpg', [
      ['Fight!', 'murder_dungeon_2', 'skeleton', '', '81'],
      ['Run away!', 'murder_dungeon_2', 'skeleton', '', '82']
    ]],
    ['murder_dungeon_2', 'Deeper into the dungeon, you are attacked by a zombie!', './images/backgrounds/dungeon.jpg', [
      ['Fight!', 'murder_dungeon_3', 'zombie', '', '83'],
      ['Run away!', 'murder_dungeon_3', 'zombie', '', '84']
    ]],
    ['murder_dungeon_3', 'Continuing on, you are attacked by an even stronger skeleton!', './images/backgrounds/dungeon.jpg', [
      ['Fight!', 'murder_dungeon_4', 'skeleton knight', '', '85'],
      ['Run away!', 'murder_dungeon_4', 'skeleton knight', '', '86']
    ]],
    ['murder_dungeon_4', 'Just before you reach the dungeon\'s exit, you are ambushed by a dark mage!', './images/backgrounds/dungeon.jpg', [
      ['Fight!', 'final_shop', 'dark mage', 'big evil sword', '87'],
      ['Run away!', 'final_shop', 'dark mage', 'big evil sword', '88']
    ]],
    ['murderville_1', 'You decide, due to the lack of a better option, to go to Murderville. Immediately upon entering the town, you are captured and dragged into an arena and locked in with a bandit! There\'s nowhere to run! "Fight or die!" shouts the arena announcer!', './images/backgrounds/murderville.jpg', [
      ['Fight!', 'murderville_2', 'bandit', '', '89']
    ]],
    ['murderville_2', 'The next battle puts you up against another bandit! Tired of these guys yet?', './images/backgrounds/murderville.jpg', [
      ['Fight!', 'murderville_3', 'bandit', '', '90']
    ]],
    ['murderville_3', 'Up next is a hired mercenary!', './images/backgrounds/murderville.jpg', [
      ['Fight!', 'murderville_4', 'mercenary', '', '91']
    ]],
    ['murderville_4', '"TIME TO DIE," shouts the announcer! The gate opens up, and in marches a huge mountain troll!', './images/backgrounds/murderville.jpg', [
      ['Fight!', 'final_shop', 'mountain troll', '', '92']
    ]],
    ['final_shop', 'After a long series of battles, you escape the danger and head on your way, soon arriving at the entrance to the evil wizard\'s tower! A traveling merchant hiding in the woods offers to sell you one item to help you on the final leg of your journey.', './images/backgrounds/towerentrance.jpg', [
    ...
    ['wizard_tower_2', 'You continue on, only to be ambushed by a skeleton knight!', './images/backgrounds/dungeon.jpg', [
      ['Fight!', 'wizard_tower_3', 'skeleton knight', '', '98']
    ]],
    ['wizard_tower_3', 'Further up the tower, A mage attacks!', './images/backgrounds/dungeon.jpg', [
      ['Fight!', 'wizard_tower_4', 'dark mage', '', '99']
    ]],
    ['wizard_tower_4', 'As you near the wizard\'s lair, the wizard\'s apprentice approaches you. "You should have backed up your computer!" she shouts, preparing to fight!', './images/backgrounds/dungeon.jpg', [
      ['Fight!', 'wizard_tower_5', 'wizard\'s apprentice', '', '100']
    ]],
    ['wizard_tower_5', 'You enter the wizard\'s lair. "HAHAHAHAHAHAHAHAHAHA" he laughs, summoning a disgusting monster to fight you, before fleeing deeper into his lair!', './images/backgrounds/dungeon.jpg', [
      ['Fight!', 'wizard_tower_6', 'demon', '', '101']
    ]],
    ['wizard_tower_6', 'The demon monster was guarding three chests! You find one rusty key lying around that looks like it will break after opening one of them. Which do you open?', './images/backgrounds/3chests.jpg', [
      ['Right!', 'wizard_tower_7', '', 'sword of murder', '102'],
      ['Middle!', 'wizard_tower_7', '', 'stick', '103'],
      ['Left!', 'wizard_tower_7', '', 'gold dragon armor', '104']
    ]],
    ['wizard_tower_7', 'At last, you reach the wizard\'s study. "Chargers for these things are like $80! Yours will be mine!" he says. Time for the final battle!', './images/backgrounds/wizardlair.jpg', [
      ['Fight!', 'win', 'wizard', '', '105']
    ]],

    ['win', 'You defeated the interdimensional wizard and got your extremely expensive Macbook back! Congrats!', './images/backgrounds/win.jpg', [
