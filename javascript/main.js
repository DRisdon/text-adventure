$(document).ready(function() {
  ...
  var scenes = [['start', 'WALUIGI IS HUNGRY! WHAT SHOULD HE DO?!?!', '', [['GO GET SOME GROCERIES!', 'groceries'], ['GO OUT TO EAT!', 'eat-out']]],
                ['groceries', 'WALUIGI DOESN\'T HAVE ENOUGH MONEY! WHAT SHOULD HE DO?!?!', '', [['GO GET SOME MONEY FROM WARIO!', 'win'], ['BE SAD!', 'lose']]],
                ['eat-out', 'WALUIGI HAS TO BATTLE THE WAITER! WHAT DO?!?!', '', [['FIGHT HIM!', 'win', [11,1]],
                  ['RUN AWAY AND BUY GROCERIES!', 'groceries'], ['BE SAD!', 'lose']]],
                ['win', 'WOW! WALUIGI ATE AND ISN\'T HUNGRY ANYMORE!', '', [['START OVER', 'start']]],
                ['lose', 'YOU LOSE!', '', [['START OVER', 'start']]]
  ...
  var player = { // player object - not in use yet
    ...
    render: function() {
      ...
      $player.css('background-image', 'url('+this.image+')');
    ...
    fight: function(combat) { // get enemy health and damage and calculate combat result
      ...
      if (player.health <= 0) {
        player.health = 0;
        console.log('You fought hard, but couldn\'t win! YOU DIED!');
      }
      else console.log('It was a tough fight! health remaining: ' +this.health + '/' + this.maxHealth);
    },
    reset: function() {
      this.maxHealth = 10;
      this.health = 10;
